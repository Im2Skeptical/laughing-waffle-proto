...
const CONFIG_BY_KIND = Object.freeze({
  [GAME_SETTINGS_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGameSettingsDraft.v4",
    libraryStorageKey: "civsurvivor.debugGameSettingsPresets.v4",
    label: "game settings",
  }),
  [GAMEPIECES_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGamepiecesDraft.v4",
    libraryStorageKey: "civsurvivor.debugGamepiecePresets.v4",
    label: "gamepieces",
  }),
});
