...
const CONFIG_BY_KIND = Object.freeze({
  [GAME_SETTINGS_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGameSettingsDraft.v1",
    libraryStorageKey: "civsurvivor.debugGameSettingsPresets.v1",
    label: "game settings",
  }),
  [GAMEPIECES_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGamepiecesDraft.v1",
    libraryStorageKey: "civsurvivor.debugGamepiecePresets.v1",
    label: "gamepieces",
  }),
});
