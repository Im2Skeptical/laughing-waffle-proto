...
const CONFIG_BY_KIND = Object.freeze({
  [GAME_SETTINGS_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGameSettingsDraft.v2",
    libraryStorageKey: "civsurvivor.debugGameSettingsPresets.v2",
    label: "game settings",
  }),
  [GAMEPIECES_DRAFT_KIND]: Object.freeze({
    ...
    draftStorageKey: "civsurvivor.debugGamepiecesDraft.v2",
    libraryStorageKey: "civsurvivor.debugGamepiecePresets.v2",
    label: "gamepieces",
  }),
});
