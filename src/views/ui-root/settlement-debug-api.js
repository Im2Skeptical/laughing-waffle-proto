...
export function publishSettlementDebugApi({
  ...
  getTimeWheelSnapshot,
  getPhaseReferenceSnapshot,
  getPhaseReferenceClickPoint,
  ...
  globalThis.__SETTLEMENT_DEBUG__ = {
    ...
    getTimeWheelSnapshot: () => getTimeWheelSnapshot?.() ?? null,
    getPhaseReferenceSnapshot: () => getPhaseReferenceSnapshot?.() ?? null,
    getPhaseReferenceClickPoint: id => getPhaseReferenceClickPoint?.(id) ?? null,
