...
import {
  ...
  purgePastStateData,
  deleteMapEntriesAtOrAfter,
  getEffectiveForecastCoverageEndSec as readEffectiveForecastCoverageEndSec,
  getPublishedForecastCoverageEndSec as readPublishedForecastCoverageEndSec,
  tryBuildForecastStateDataFromRetainedAnchor as rebuildForecastStateDataFromRetainedAnchor,
  buildScheduledActionsBySecond,
  invalidateSubjectValuesFromSec as invalidateCachedSubjectValuesFromSec,
  pushSubjectValueSec,
} from "./forecast-state-cache.js";
...
export function createTimeGraphController({
  ...
  function getEffectiveForecastCoverageEndSec(tl) {
    return readEffectiveForecastCoverageEndSec(
      tl,
      projection,
      ASYNC_FORECAST_STEP_SEC
    );
  }

  function getPublishedForecastCoverageEndSec(tl) {
    return readPublishedForecastCoverageEndSec(
      tl,
      graphCache,
      projection,
      ASYNC_FORECAST_STEP_SEC
  ...
  function tryBuildForecastStateDataFromRetainedAnchor(sec, historyEndSec, tl = null) {
    return rebuildForecastStateDataFromRetainedAnchor(
